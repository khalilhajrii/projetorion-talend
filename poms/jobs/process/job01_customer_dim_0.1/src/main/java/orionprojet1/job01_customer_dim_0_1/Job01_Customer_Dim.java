...
package orionprojet1.job01_customer_dim_0_1;
...
public static class Customer_DimStruct implements routines.system.IPersistableRow<Customer_DimStruct> {
    final static byte[] commonByteArrayLock_ORIONPROJET1_Job01_Customer_Dim = new byte[0];
    static byte[] commonByteArray_ORIONPROJET1_Job01_Customer_Dim = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String Customer_fistname;

				public String getCustomer_fistname () {
					return this.Customer_fistname;
				}
	...
	public void copyDataTo(Customer_DimStruct other) {
		...
		other.Customer_ID = this.Customer_ID;
	            ...
	            other.Customer_fistname = this.Customer_fistname;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ORIONPROJET1_Job01_Customer_Dim.length) {
				if(length < 1024 && commonByteArray_ORIONPROJET1_Job01_Customer_Dim.length == 0) {
   					commonByteArray_ORIONPROJET1_Job01_Customer_Dim = new byte[1024];
				} else {
   					commonByteArray_ORIONPROJET1_Job01_Customer_Dim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ORIONPROJET1_Job01_Customer_Dim, 0, length);
			strReturn = new String(commonByteArray_ORIONPROJET1_Job01_Customer_Dim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ORIONPROJET1_Job01_Customer_Dim) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Customer_fistname = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Customer_fistname,dos);
    ...
    public String toString() {
		...
		sb.append(",Customer_fistname="+Customer_fistname);
...
java.sql.Connection conn_tDBOutput_1 = null;
		...
		if(dbProperties_tDBOutput_1 == null || dbProperties_tDBOutput_1.trim().length() == 0) {
			url_tDBOutput_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "oriondb" + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "oriondb" + "?" + properties_tDBOutput_1;
		}
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WqzyuOURb5Amfi3OYkppHLRiEWqaXMIDL25BYg==");
...
int count_tDBOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "Customer_Dim" + "` WHERE `Customer_ID` = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "Customer_Dim" + "` (`Customer_ID`,`Customer_Country`,`Customer_Gender`,`Customer_Name`,`Customer_fistname`,`Customer_Lastname`,`Customer_Birth_Date`,`Customer_Type`,`Customer_Group`,`Customer_Age`,`Customer_Age_Group`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
	        
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE `" + "Customer_Dim" + "` SET `Customer_Country` = ?,`Customer_Gender` = ?,`Customer_Name` = ?,`Customer_fistname` = ?,`Customer_Lastname` = ?,`Customer_Birth_Date` = ?,`Customer_Type` = ?,`Customer_Group` = ?,`Customer_Age` = ?,`Customer_Age_Group` = ? WHERE `Customer_ID` = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
			...
			String url_tDBInput_1 = "jdbc:ucanaccess://" + "C:/Users/khalil/Downloads/projet orion/source des données/orion.mdb" + ";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true";
	        String dbUser_tDBInput_1 = "";
	        
    		
    		
    		 
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yDGvc7bC3/943P5rgEMdMsSCKH1i1s+pX5CYUw==");
...
Var.Age = Mathematical.INT(TalendDate.formatDate("yyyy",
...
Customer_Dim_tmp.Customer_fistname = customer.CUSTOMER_FIRSTNAME ;
...
} else {pstmt_tDBOutput_1.setDouble(1, Customer_Dim.Customer_ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(1, Customer_Dim.Customer_Country);
}

                        if(Customer_Dim.Customer_Gender == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, Customer_Dim.Customer_Gender);
}

                        if(Customer_Dim.Customer_Name == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, Customer_Dim.Customer_Name);
}

                        if(Customer_Dim.Customer_fistname == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, Customer_Dim.Customer_fistname);
}

                        if(Customer_Dim.Customer_Lastname == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, Customer_Dim.Customer_Lastname);
}
...
} else {pstmtUpdate_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(date_tDBOutput_1));
}
} else {
...
} else {pstmtUpdate_tDBOutput_1.setString(7, Customer_Dim.Customer_Type);
}

                        if(Customer_Dim.Customer_Group == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8, Customer_Dim.Customer_Group);
}

                        if(Customer_Dim.Customer_Age == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(9, Customer_Dim.Customer_Age);
}

                        if(Customer_Dim.Customer_Age_Group == null) {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10, Customer_Dim.Customer_Age_Group);
}

                        if(Customer_Dim.Customer_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(11 + count_tDBOutput_1, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_1.setDouble(11 + count_tDBOutput_1, Customer_Dim.Customer_ID);
}
...
} else {pstmtInsert_tDBOutput_1.setDouble(1, Customer_Dim.Customer_ID);
}

                        if(Customer_Dim.Customer_Country == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, Customer_Dim.Customer_Country);
}

                        if(Customer_Dim.Customer_Gender == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, Customer_Dim.Customer_Gender);
}

                        if(Customer_Dim.Customer_Name == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, Customer_Dim.Customer_Name);
}

                        if(Customer_Dim.Customer_fistname == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, Customer_Dim.Customer_fistname);
}

                        if(Customer_Dim.Customer_Lastname == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, Customer_Dim.Customer_Lastname);
}
...
} else {pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(date_tDBOutput_1));
}
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, Customer_Dim.Customer_Type);
}

                        if(Customer_Dim.Customer_Group == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(9, Customer_Dim.Customer_Group);
}

                        if(Customer_Dim.Customer_Age == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(10, Customer_Dim.Customer_Age);
}

                        if(Customer_Dim.Customer_Age_Group == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(11, Customer_Dim.Customer_Age_Group);
}
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
			...
			String url_tDBInput_2 = "jdbc:ucanaccess://" + "C:/Users/khalil/Downloads/projet orion/source des données/orion.mdb" + ";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true";
	        String dbUser_tDBInput_2 = "";
	        
    		
    		
    		 
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:hlS6t8XspQmvHH67uiGFx21ROa6K6cwxXceOkQ==");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Job01_Customer_Dim.class.getClassLoader().getResourceAsStream("orionprojet1/job01_customer_dim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     99997 characters generated by Talend Open Studio for Data Integration 
 *     on the 21 mai 2021 12:29:27 WAT
 ************************************************************************************************/